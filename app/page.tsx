...
//   useEffect(() => {
//     if (selectedLanguage) {
//       fetch(`http://localhost:8000/api/audio/${selectedLanguage}`)
//         .then((res) => res.json())
//         .then((data) => {
...
//           <div className="text-xl font-bold tracking-tight ml-4">IIElevenLabs</div>
//         </div>

//         {/* Center Links */}
//         <div className="flex items-center justify-center space-x-8 col-start-2">
...
//         {/* Right Section */}
//         <div className="flex items-center justify-end col-start-3 mr-4 space-x-3">
//           <Button variant="ghost" size="sm" className="text-sm font-normal">
//             Log in
//           </Button>
//           <Button
//             size="sm"
//             className="bg-black text-white hover:bg-gray-800 rounded-full px-6 text-sm font-normal"
//           >
//             Sign up
//           </Button>
//         </div>
...
//         }}
//       >
//         <h1 className="font-waldenburg text-5xl font-normal leading-[110%] tracking-[-0.03em] text-center mb-8 max-w-5xl mx-auto">
//           The most realistic voice AI platform
//         </h1>

//         <p className="font-waldenburg whitespace-pre-wrap text-center text-lg font-normal leading-[140%] tracking-[0.01em] mt-4 mb-12 max-w-5xl mx-auto -mx-1">
...
//         </p>
//         <div className="mt-5 flex flex-wrap justify-center gap-3 flex-row items-center">
//           <Button className="font-waldenburg-ht text-sm leading-[110%] tracking-[0.05em] uppercase inline-flex h-10 w-fit min-w-20 items-center justify-center whitespace-nowrap rounded-full bg-black px-4 text-white transition-all duration-300 ease-[cubic-bezier(0.31,0.325,0,0.92)] outline-offset-0 outline-2 outline-transparent">
//             SIGN UP
//           </Button>
//           <Button className="font-waldenburg-ht text-sm leading-[110%] tracking-[0.05em] uppercase inline-flex h-10 w-fit min-w-20 items-center justify-center whitespace-nowrap rounded-full bg-neutral-50 px-4 text-black transition-all duration-300 ease-[cubic-bezier(0.31,0.325,0,0.92)] outline-offset-0 outline-2 outline-transparent hover:bg-neutral-50 hover:text-black hover:shadow-none">
//             CONTACT SALES
//           </Button>
//         </div>
//       </div>
...
//                 className={`flex items-center space-x-1.5 px-4 py-2 rounded-lg text-xs font-medium transition-all duration-200 border ${
//     activeTab === tab.id
...
//                     <path fill="currentColor" fillRule="evenodd" d="M1 2.5c0-.828.672-1.5 1.5-1.5h6.5c.828 0 1.5.672 1.5 1.5v3.013a.5.5 0 1 1-1 0V2.5a.5.5 0 0 0-.5-.5H2.5a.5.5 0 0 0-.5.5v6.5c0 .276.224.5.5.5h3a.5.5 0 1 1 0 1h-3A1.5 1.5 0 0 1 1 9z" clipRule="evenodd"></path>
//                     <path fill="currentColor" fillRule="evenodd" d="M5.244 4.5H4.25a.25.25 0 0 1-.25-.25v-.5c0-.138.112-.25.25-.25h3c.138 0 .25.112.25.25v.5c0 .138-.112.25-.25.25H6.244v2.75c0 .138-.112.25-.25.25h-.5a.25.25 0 0 1-.25-.25zM12.258 5.613a.5.5 0 0 1 .704.07 6.8 6.8 0 0 1 1.538 4.317 6.8 6.8 0 0 1-1.538 4.317.5.5 0 0 1-.774-.634A5.792 5.792 0 0 0 13.5 10a5.792 5.792 0 0 0-1.312-3.683.5.5 0 0 1 .07-.704" clipRule="evenodd"></path>
//                     <path fill="currentColor" fillRule="evenodd" d="M10.634 6.663a.5.5 0 0 1 .704.07A5.144 5.144 0 0 1 12.5 10a5.144 5.144 0 0 1-1.163 3.267.5.5 0 0 1-.773-.633A4.144 4.144 0 0 0 11.5 10a4.144 4.144 0 0 0-.936-2.634.5.5 0 0 1 .07-.703" clipRule="evenodd"></path>
//                     <path fill="currentColor" fillRule="evenodd" d="M8.984 7.638a.5.5 0 0 1 .704.072A3.616 3.616 0 0 1 10.5 10a3.616 3.616 0 0 1-.812 2.29.5.5 0 1 1-.776-.632A2.616 2.616 0 0 0 9.5 10c0-.632-.225-1.21-.588-1.658a.5.5 0 0 1 .072-.704M7.361 8.686a.5.5 0 0 1 .703.074c.273.338.436.77.436 1.24s-.163.902-.436 1.24a.5.5 0 0 1-.777-.628c.127-.157.213-.386.213-.612s-.086-.455-.213-.612a.5.5 0 0 1 .074-.702" clipRule="evenodd"></path>
//                   </svg>
//                 ) : (
...
//                 value={sampleText}
//                 readOnly
//                 className="font-waldenburg w-full h-[300px] resize-none border-0 rounded-lg p-0
//              text-lg leading-relaxed bg-white text-gray-800 
...
//                 {/* Samara */}
//                 <button className="bg-white hover:bg-gray-50 group flex flex-shrink-0 items-center gap-2 rounded-lg p-2 pr-3 text-black border border-gray-200">
//                   <div className="flex items-center gap-2">
//                     <div className="flex items-center">
//                       <div className="rounded-full overflow-hidden w-5 h-5 group-hover:border-gray-400 bg-gray-300">
...
//                   <div className="text-xs font-bold text-black">Narrate a story</div>
//                 </button>
...
//                   <div className="flex items-center gap-2">
//                     <div className="flex items-center">
//                       <div className="rounded-full overflow-hidden w-5 h-5 group-hover:border-gray-400 relative z-10 bg-pink-200">
//                         <img src="/jessica.webp" alt="Speaker 1" className="w-full h-full object-cover" />
//                       </div>
//                       <div className="rounded-full overflow-hidden w-5 h-5 group-hover:border-gray-400 -ml-2 relative z-0">
...
//                   </div>
//                   <div className="bg-gray-600 h-3 w-px"></div>
//                   <div className="text-xs font-bold text-black">Create a dialogue</div>
//                 </button>
...
//                   <div className="flex items-center gap-2">
//                     <div className="flex items-center">
//                       <div className="rounded-full overflow-hidden w-5 h-5 group-hover:border-gray-400 bg-green-300">
...
//                   </div>
//                   <div className="bg-gray-600 h-3 w-px"></div>
//                   <div className="text-xs font-bold text-black">Voiceover a game</div>
//                 </button>
...
//                   <div className="flex items-center gap-2">
//                     <div className="flex items-center">
//                       <div className="rounded-full overflow-hidden w-5 h-5 group-hover:border-gray-400 bg-purple-300">
...
//                   </div>
//                   <div className="bg-gray-600 h-3 w-px"></div>
//                   <div className="text-xs font-bold text-black">Play a drill sergeant</div>
//                 </button>
...
//                   <div className="flex items-center gap-2">
//                     <div className="flex items-center">
//                       <div className="rounded-full overflow-hidden w-5 h-5 group-hover:border-gray-400 bg-blue-800">
...
//                   </div>
//                   <div className="bg-gray-600 h-3 w-px"></div>
//                   <div className="text-xs font-bold text-black">Recount an old story</div>
//                 </button>
...
//                   <div className="flex items-center gap-2">
//                     <div className="flex items-center">
//                       <div className="rounded-full overflow-hidden w-5 h-5 group-hover:border-gray-400 bg-pink-200">
...
//                   </div>
//                   <div className="bg-gray-600 h-3 w-px"></div>
//                   <div className="text-xs font-bold text-black">Provide customer support</div>
//                 </button>
//               </div>
...
//             {/* Powered by */}
//             <div
//               className="relative z-8 px-8 py-4 text-center rounded-b-xl -mx-2 -mb-2"
//               style={{
//                 background:
